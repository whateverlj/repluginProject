...
public class SPUtils {
     ...
     * @param datalist
     */
    public static void setDataList(String tag, List<Double> datalist,Context context) {
     ...
     * @return
     */
    public static List<Double> getDataList(String tag,Context context) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME,
                Context.MODE_PRIVATE);
        ...
        Gson gson = new Gson();
        datalist = gson.fromJson(strJson, new TypeToken<List<Double>>() {
        }.getType());
        return datalist;
